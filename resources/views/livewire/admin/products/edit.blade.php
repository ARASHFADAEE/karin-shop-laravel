<div>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2 space-x-reverse">
                <a href="{{ route('admin.products.images', $product) }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center">
    ...
    <form wire:submit="save">
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">مدیریت تصاویر</h3>
                <p class="text-sm text-gray-600 mt-1">آپلود و مدیریت تصاویر محصول</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-yellow-300 rounded-lg p-6 text-center hover:border-yellow-400 transition-colors">
                            ...
                            <label for="featured-images" class="cursor-pointer">
                                ...
                                <div class="mt-4">
                                    <p class="text-sm text-yellow-600">کلیک کنید یا فایل‌ها را اینجا بکشید</p>
                                    <p class="text-xs text-yellow-500 mt-1">PNG, JPG, GIF تا 2MB</p>
                                </div>
                            </label>
                        </div>
                ...
                @if($images || $featuredImages)
                    <div class="mb-6">
                        <button type="button" 
                                ...
                                class="bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white px-6 py-2 rounded-lg">
                            <span wire:loading.remove wire:target="uploadImages">آپلود تصاویر</span>
                            <span wire:loading wire:target="uploadImages">در حال آپلود...</span>
                        </button>
                    </div>
                @endif

                <!-- Current Images -->
                @if($product->featuredImages->count() > 0 || $product->images->count() > 0)
                    <div class="border-t border-gray-200 pt-6">
                        <h4 class="text-md font-medium text-gray-900 mb-4">تصاویر موجود</h4>
                        
                        <!-- Featured Images -->
                        @if($product->featuredImages->count() > 0)
                            <div class="mb-6">
                                <h5 class="text-sm font-medium text-gray-700 mb-3">تصاویر شاخص</h5>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                                                <button wire:click="deleteImage({{ $image->id }}, 'featured')" 
                                                        class="bg-red-600 hover:bg-red-700 text-white p-2 rounded-full mr-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                        ...
                        @if($product->images->count() > 0)
                            <div>
                                <h5 class="text-sm font-medium text-gray-700 mb-3">تصاویر عادی</h5>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                                                <button wire:click="setAsFeatured({{ $image->id }})" 
                                                        class="bg-yellow-600 hover:bg-yellow-700 text-white p-2 rounded-full mr-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                    </svg>
                                                </button>
                                                <button wire:click="deleteImage({{ $image->id }}, 'regular')" 
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="text-xs text-blue-700 mt-1 list-disc list-inside">
                    <li>تغییر اطلاعات محصول بر SEO و لینک‌های موجود تأثیر می‌گذارد</li>
                    <li>اسلاگ جدید به صورت خودکار از ترجمه انگلیسی نام محصول تولید می‌شود</li>
                    ...
                    <li>تصاویر محصول از صفحه مدیریت تصاویر قابل ویرایش است</li>
                </ul>
            </div>
        </div>
    </div>
