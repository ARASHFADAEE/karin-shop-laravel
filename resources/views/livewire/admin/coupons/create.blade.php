<div>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-gray-900">ایجاد کوپن جدید</h2>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">اطلاعات کوپن</h3>
        </div>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="text-xs text-blue-700 mt-1 list-disc list-inside">
                    <li>کد کوپن باید یکتا باشد و نمی‌توان آن را تغییر داد</li>
                    <li>کوپن‌های درصدی نمی‌توانند بیشتر از 100 درصد باشند</li>
                    <li>حداقل مبلغ خرید برای اعمال کوپن در نظر گرفته می‌شود</li>
                    <li>محدودیت استفاده تعداد کل استفاده از کوپن را کنترل می‌کند</li>
                    <li>کوپن‌های منقضی شده به صورت خودکار غیرفعال می‌شوند</li>
                </ul>
            </div>
        </div>
    </div>
